...
<div class="panel-body">
    ...
    {!! Form::open(array('url'=>'/admin/lessons','class'=>'form-horizontal','method'=>'POST','id'=>'lesson')) !!}
    ...
    <div class="form-group">
        ...
        {!! Form::select('grade_id', ['' => '--- Select Grade ---']+$grades,null, ['class' => 'form-control']) !!}
    </div>

    <div class="form-group">
        {!! Form::label('subject_id', 'Subject'); !!}
        {!! Form::select('subject_id', ['' => '--- Select Subject ---'],null, ['class' => 'form-control']) !!}
    </div>

    <div class="form-group">
        {!! Form::label('theme_id', 'Theme'); !!}
        {!! Form::select('theme_id', ['' => '--- Select Theme ---'],null, ['class' => 'form-control']) !!}
    </div>    
