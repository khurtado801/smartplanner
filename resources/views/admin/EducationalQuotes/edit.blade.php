...
<div class="panel-body">
    {!! Form::model($educationalquote,array('route' => array('admin.educationalquotes.update', $educationalquote->id),'class'=>'form-horizontal','method'=>'PUT','id'=>'educationalquotes')) !!}
