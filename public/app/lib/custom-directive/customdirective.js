...
customDirective.filter('ifEmpty', function() {
...
customDirective.directive('fallbackSrc', function () {
	var fallbackSrc = {
...
customDirective.directive('ngLightbox', ['$compile', function($compile) {
...
customDirective.directive('ngLightboxClose', function() {
	return function(scope, element, attr) {
