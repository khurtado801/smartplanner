...
var aboutPageApp = angular.module('aboutPageModule', ['ngRoute']);

aboutPageApp.config(function($routeProvider) {
	$routeProvider
		.when('/about', {
			templateUrl : 'templates/site/about/about.html',
...
homePageApp.config(['$locationProvider','$routeProvider', 
   function($locationProvider, $routeProvider) {
      $routeProvider
         ...
         .when('/login', {
            templateUrl : 'templates/site/auth/login.html',
         	// controller  : 'authController'
         })
         // route for the forgot password
         .when('/register', {
            templateUrl : 'templates/site/auth/register.html',
            // controller  : 'authController'
         })
         // route for the forgot password
         .when('/forgot', {
            templateUrl : 'templates/site/auth/forgot.html',
         	// controller  : 'authController'
         })
}]);
...
contactPageApp.config(function($routeProvider) {
	$routeProvider
		.when('/contact', {
			templateUrl : 'templates/site/contact/contact.html',
...
homePageApp.config(function($routeProvider) {
	$routeProvider
		...
		.when('/truck/searchtruck', {
			templateUrl : 'templates/site/home/searchtruck.html',
			controller  : 'homeController'
		})
});


var aboutPageApp = angular.module('aboutPageModule');
	aboutPageApp.controller('aboutController', ['$scope', 
		function($scope) {
...
var contactPageApp = angular.module('contactPageModule');
	contactPageApp.controller('contactController', ['$scope', 
		function($scope) {
			$scope.message = 'Welcome to Contact Page, There!!';
...
homePageApp.controller('homeController', ['$scope', '$location', '$http', '$routeParams', 
	function($scope, $location, $http, $routeParams) {
	    ...
	    $location.path('/truck/searchtruck');

	    };
	    $scope.searchtrucklist = function () {

	      var dashboard = {
	        'sourceCity': $routeParams.sourceCity,
	        'destinationCity': $routeParams.destinationCity
	      };
	      $http.post('/api/truck/searchtrucklist', dashboard).success(function(response) {
